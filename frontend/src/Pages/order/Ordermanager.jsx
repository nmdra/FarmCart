            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredShops.length > 0 ? (
                filteredShops.map((shop) => (
                  <div key={shop._id} className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition-shadow duration-200">
                    {shop.image && (
                      <img 
                        src={shop.image} 
                        alt={`${shop.name} image`} 
                    ...
                    <p className="text-gray-600">{shop.address.streetName}, {shop.address.city}, {shop.district}</p>
