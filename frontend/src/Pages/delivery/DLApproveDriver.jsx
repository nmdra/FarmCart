        ...
        return (
            ...
            <div className="flex min-h-screen bg-gray-50">
                ...
                <main className="flex-1 ml-64 p-24 flex justify-start items-start">
                    <div className="text-center text-xl font-semibold">No pending forms to approve.</div>
                </main>
            </div>
        );
    }
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <main className="flex-1 ml-64 p-16 overflow-y-auto">
                <div className="max-w-7xl mx-auto p-8 bg-white shadow-md rounded-lg">
                    <h2 className="text-3xl font-bold mb-6 text-center">Pending Driver Approvals</h2>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-sm">
                            <thead className="bg-gray-200">
                                <tr>
                                    <th className="px-6 py-3 border-b-2 text-left text-gray-600">Full Name</th>
                                    <th className="px-6 py-3 border-b-2 text-left text-gray-600">Email</th>
                                    <th className="px-6 py-3 border-b-2 text-left text-gray-600">Phone</th>
                                    <th className="px-6 py-3 border-b-2 text-left text-gray-600">Vehicle Type</th>
                            ...
                            <tbody>
                                {pendingForms.map((form) => (
                                    <tr key={form._id} className="hover:bg-gray-100">
                                        <td className="px-6 py-4 border-t text-left">{form.fullName}</td>
                                        <td className="px-6 py-4 border-t text-left">{form.email}</td>
                                        <td className="px-6 py-4 border-t text-left">{form.phone}</td>
                                        <td className="px-6 py-4 border-t text-left">{form.vehicleType}</td>
