                ...
                <div className="max-w-7xl mx-auto p-6 bg-white shadow-md rounded-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
                        ...
                        <div className="bg-purple-100 p-6 rounded-lg shadow-md">
                            <h2 className="text-lg font-semibold text-purple-800">Pending Forms</h2>
                            <p className="text-4xl font-bold text-purple-800 mt-4">{stats.pendingForms}</p>
                        </div>
                    </div>
                            ...
                            <table className="min-w-full bg-white border border-gray-200">
                                ...
                                <tbody>
                                    {pendingForms.slice(0, 5).map((form) => (
                                        <tr key={form._id} className="bg-white hover:bg-gray-100">
                                            ...
                                            <td className="px-4 py-2 border">{form.vehicleType}</td>
                                    ...
                                    <tr className="bg-white hover:bg-gray-100">
                                        ...
                                        <td className="px-4 py-2 border">
                                            <button
                                                ...
                                                onClick={() => handleViewDelivery('1234')}
                                            >
                                                View Delivery
                                            </button>
                                        </td>
