...
const UpdateCoupon = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Error updating coupon, please try again', 'error');
        }
    };
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 p-32 ml-64 overflow-y-auto">
                <form onSubmit={handleSubmit} className="bg-white p-12 pl-6 rounded-lg shadow-md w-full">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Update Coupon</h3>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                />
                                {errors.couponCode && <p className="text-red-500 text-xs">{errors.couponCode}</p>}
                            </div>
                            <div>
