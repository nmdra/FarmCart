...
const AddCoupon = () => {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'discount') {
            ...
            setErrors({ ...errors, discount: !discountRegex.test(value) ? 'Discount must be a number' : '' });
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Error creating coupon, please try again', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 p-32 ml-64 overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-12 pl-6 rounded-lg shadow-md w-full">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Add Coupon</h3>
