...
const AddStaff = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Error adding staff member, please try again', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handlePhoneKeyPress = (e) => {
        ...
        if (!allowedChars.test(e.key) || (e.target.value.length >= 10 && e.key !== 'Backspace')) {
            e.preventDefault();
        }
    };
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 p-32 ml-64 overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-12 pl-6 rounded-lg shadow-md w-full">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Add Staff Member</h3>
                        ...
                        <div className="md:col-span-2 space-y-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="Blog manager">Deliver</option>
                                    <option value="Order manager">Order Manger</option>
