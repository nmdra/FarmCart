        ...
        <div className="flex flex-col min-h-screen bg-gray-50">
            <div className="flex flex-1 mt-16">
                ...
                <main className="flex-1 ml-60 p-24 pt-8 overflow-y-auto">
                    ...
                    <Table aria-label="Coupons Table" bottomContent={
                        ...
                        <TableBody>
                            {items.map((coupon, index) => (
                                <TableRow key={coupon._id} className="border-b-1">
                                    ...
                                    <TableCell className="flex gap-6 justify-center items-center h-16">
                                        ...
                                        <Tooltip color="warning" content="Edit coupon">
                                            <span className="text-lg text-warning cursor-pointer active:opacity-50">
                                                <Button onClick={() => handleEditCoupon(coupon._id)}>Edit</Button>
                                            </span>
                                        </Tooltip>
