    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filteredProducts?.map(product => (
          <div key={product._id} className="product-card border rounded-lg shadow-lg p-4 bg-white">
            ...
            <Link to={`/shop/${id}/product/${product._id}`} className="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition duration-200">
              View Details
            </Link>
          </div>
        ))}
