...
const DownloadReceipt = ({ order }) => {
    ...
    const generatePDF = () => {
        ...
        const props = {
            ...
            contact: {
                ...
                phone: order.shippingAddress?.phone, // Optional chaining to avoid errors
            },
            invoice: {
                label: 'Invoice #: ',
    ...
    return (
        <button
            onClick={generatePDF}
            className="px-4 py-2 mt-4 text-white transition duration-200 ease-in-out bg-green-500 rounded shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300"
        >
            Download Receipt
        </button>
    )
